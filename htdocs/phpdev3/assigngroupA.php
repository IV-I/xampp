...
<main>
    ...
    <div class="signupform">
        <div class="w3-card w3-margin w3-padding">
            <h2 align="center">Assign Group A</h2>

            <form action="processassigngroupA.php" method="post" class="w3-container">
                ...
                <input class="w3-input w3-border" type="text" name="project_team" required></input>
                <br>
