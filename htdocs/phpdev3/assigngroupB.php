...
$query = 'SELECT * FROM assigngroupb';
$assigngroupb = mysqli_query($db, $query);
...
<main>
    ...
    <div class="signupform">
        <div class="w3-card w3-margin w3-padding">
            <h2 align="center">Assign Group B</h2>

            <form action="processassigngroupB.php" method="post" class="w3-container">
            ...
            <hr>
            <ul>
                <?php while ($row = mysqli_fetch_assoc($assigngroupb)): ?> <!-- tRY coursework -->
