...
<main>
    ...
    <div class="signupform">
        <div class="w3-card w3-margin w3-padding">
            <h2 align="center">Assign Group E</h2>

            <form action="processassigngroupE.php" method="post" class="w3-container">
            ...
            <hr>
            <ul>
                <?php while ($row = mysqli_fetch_assoc($assigngroupe)): ?> <!-- tRY coursework -->
